...
namespace OpenZWave.NetStandard.Validations
{
    /// <summary>
    ...
    public static class Requires
    {
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void PathIsRooted(string path, string baseDirectory, string parameterName)
        {
            ...
            Argument(path.ToLowerInvariant().TrimEnd(Path.DirectorySeparatorChar).StartsWith(baseDirectory.ToLowerInvariant().TrimEnd(Path.DirectorySeparatorChar)),parameterName, $"Path '{path}' does not represent a subfolder of '{baseDirectory}'");
        }
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void TargetIsType<T>(object target, string name)
        {
        ...
        [DebuggerStepThrough]
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void FileNotFound(string filePath, string parameterName)
        {
            NotNullOrWhiteSpace(filePath, parameterName);
            if (File.Exists(filePath))
            {
